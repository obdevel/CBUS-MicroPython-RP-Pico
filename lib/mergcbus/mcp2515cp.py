...
class MCP2515cp:  # pylint:disable=too-many-instance-attributes
    ...
    def __init__(
        ...
        self._debug = debug
        self._bus_device_obj = SPI(0, baudrate=10_000_000, polarity=0, phase=0, bits=8, sck=Pin(2), mosi=Pin(3), miso=Pin(4))
        self._cs_pin = cs_pin
